...
export default function Cards() {
  ...
  const handleCheckOut = async () => {
    ...
    try {
      const response = await fetch(`https://snacks-sprint-shop.onrender.com/api/user/orders/create`, {
        method: "POST",
        headers: {
        ...
        <MDBContainer className="py-5 h-100">
          <MDBRow className="justify-content-center my-4">
            <MDBCol md="8">
              ...
              <MDBCard className="mb-4 bg-white deliverytime">
              ...
              <MDBCard className="mb-4 bg-white text-black cartbox">
              ...
              <MDBCard className="mb-4 mb-lg-0 text-black bg-white onlinecard">
                <MDBCardBody>
                  <p>
            ...
            {/*  checkout section  */}
            <MDBCol md="4">
              <MDBCard className="mb-4 bg-white Summarybox">
                <MDBCardHeader>
                  <MDBTypography
                    tag="h5"
                    className="mb-0 fs-3"
                ...
                <MDBCardBody>
                  <MDBListGroup flush>
                    ...
                    <MDBListGroupItem className="d-flex text-black justify-content-between align-items-center px-0 bg-white fs-5 deliverybox">
